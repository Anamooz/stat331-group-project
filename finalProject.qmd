...
Once fully cleaned, we then fit our data to a linear model to test our hypothesis of a positive trend over time (Fig 3). This is accomplished by guessing a linear fit to our average data points and showing that the trendline agrees with the change in the data over time.
