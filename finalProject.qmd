...
Additionally, it was determined that the only countries missing CO2 emissions data before 2022 were Monaco and San Marino, so those countries will be dropped from this analysis. Similarly, Liechtenstein is missing much of its GDP data before 2022, so it will also be dropped from the analysis.
