...
combined_clean |> 
  ...
  theme_minimal()
```
Figure 1: The relationship between avg GDP per capita and avg CO2 per capita (Aggregate values over all years for each country). Very linear relationship between the two.
