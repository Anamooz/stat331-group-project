...
Make a nicely formatted table that presents the following: - The variance in the response values. (A) - The variance in the fitted values from your regression model. (B) - The variance in the residuals from your regression model. - The model R2 (B / A)
